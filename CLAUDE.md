...
Branch: `fix/scope-relayout-to-workspace`. Build 120. PID check: `pgrep -x OmniWM`.
...
| 36 | Workspace switch blinks (verificationMismatch) | **FIXED** | 120 | Axis-aware frame tolerance (4px Y/height, 1px X/width) + upstream quantum learning ported. 0 mismatches in soak test (was 104). Memorygraph `5afef9c1`. |
